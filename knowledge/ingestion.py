# tools/data_ingestion.py - Local-Only Data Ingestion
import os
import json
import sqlite3
import hashlib
...
class DataIngestion:
    ...
    def _generate_local_embedding(self, text: str) -> List[float]:
        """
        Generate a simple local embedding using keyword hashing
        0 API calls - Just for local similarity matching
        """
